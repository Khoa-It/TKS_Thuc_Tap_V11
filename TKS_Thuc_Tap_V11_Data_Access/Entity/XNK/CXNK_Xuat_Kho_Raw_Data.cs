...
namespace TKS_Thuc_Tap_V11_Data_Access.Entity.XNK
{
    public class CXNK_Xuat_Kho_Raw_Data
    {
        ...
        private DateTime? m_dtmNgay_Xuat;
        ...
        {
            get { return m_dtmNgay_Xuat; }
            set { m_dtmNgay_Xuat = value; }
        }

        public string Ngay_Xuat_Kho_Text
        {
            get { return m_dtmNgay_Xuat.HasValue ? m_dtmNgay_Xuat.Value.ToString("dd/MM/yyyy") : string.Empty; }
        }

        public string So_Phieu_Xuat
        {
            get { return m_strSo_Phieu_Xuat; }
            set { m_strSo_Phieu_Xuat = value.Trim(); }
        }
