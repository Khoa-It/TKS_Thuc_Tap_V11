...
namespace TKS_Thuc_Tap_V11_Data_Access.Entity.XNK
{
    public class CXNK_Nhap_Kho
    {
        ...
        private string m_strNgay_Nhap_Kho_Text;
        ...
        public string Ngay_Nhap_Kho_Text
        {
            get
            {
                return m_dtmNgay_Nhap_Kho.HasValue ? m_dtmNgay_Nhap_Kho.Value.ToString("dd/MM/yyyy") : CConst.STR_VALUE_NULL;
            }
        }
        ...
        public bool IsValid(out string p_strMessage)
        {
            ...
            {
                p_strMessage = "Ngày Nhập Kho không được để trống.";
                return false;
            }
        ...
        {
            if (obj is CXNK_Nhap_Kho other)
            {
                return Kho_ID == other.Kho_ID &&
                       NCC_ID == other.NCC_ID &&
                       string.Equals(So_Phieu_Nhap_Kho, other.So_Phieu_Nhap_Kho, StringComparison.OrdinalIgnoreCase) &&
                       Nullable.Equals(Ngay_Nhap_Kho, other.Ngay_Nhap_Kho);
            }
            return false;
        }
        ...
        {
            return HashCode.Combine(Kho_ID, NCC_ID, So_Phieu_Nhap_Kho?.ToLower(), Ngay_Nhap_Kho);
        }
    }
}
