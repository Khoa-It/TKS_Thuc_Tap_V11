...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.Cache
{
    public class CCache_Kho_User
    {
        ...
        public static void Add_Data(CDM_Kho_User p_objData)
        {
            ...
            string v_strKey_Code = CUtility.Tao_Key(p_objData.Kho_ID, p_objData.Ma_Dang_Nhap);
        ...
        public static void Delete_Data(long p_iAuto_ID)
        {
            ...
            string v_strKey_Code = CUtility.Tao_Key(v_objData.Kho_ID, v_objData.Ma_Dang_Nhap);
        ...
        public static List<CDM_Kho_User> List_Data()
        {
            return Arr_Data;
        }
    }
