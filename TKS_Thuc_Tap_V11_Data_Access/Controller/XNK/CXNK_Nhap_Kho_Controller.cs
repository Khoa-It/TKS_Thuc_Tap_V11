...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.XNK
{
    public class CXNK_Nhap_Kho_Controller
    {
        ...
        public List<CXNK_Nhap_Kho> F3001_sp_sel_List_NK_By_Date_Only(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            List<CXNK_Nhap_Kho> v_arrRes = new List<CXNK_Nhap_Kho>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                ...
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F3001_sp_sel_List_NK_By_Date_Only", p_dtmFrom, p_dtmTo);
        ...
        public List<CXNK_Nhap_Kho> F3001_sp_sel_List_NK_By_Created()
        {
            List<CXNK_Nhap_Kho> v_arrRes = new List<CXNK_Nhap_Kho>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                ...
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F3001_sp_sel_List_NK_By_Created");
