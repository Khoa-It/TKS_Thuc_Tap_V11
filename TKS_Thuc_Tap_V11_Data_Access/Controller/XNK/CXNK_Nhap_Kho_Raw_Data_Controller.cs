...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.XNK
{
    public class CXNK_Nhap_Kho_Raw_Data_Controller
    {
        ...
        public List<CXNK_Nhap_Kho_Raw_Data> F3001_sp_sel_List_NKRD_For_Form_List_By_Date(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            List<CXNK_Nhap_Kho_Raw_Data> v_arrRes = new List<CXNK_Nhap_Kho_Raw_Data>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                ...
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F3001_sp_sel_List_NKRD_For_Form_List_By_Date", p_dtmFrom, p_dtmTo);
        ...
        public List<CXNK_Nhap_Kho_Raw_Data> F4005_sp_sel_List_NKRD_By_Created()
        {
            List<CXNK_Nhap_Kho_Raw_Data> v_arrRes = new List<CXNK_Nhap_Kho_Raw_Data>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F4005_sp_sel_List_NKRD_By_Created");
        ...
        public List<CXNK_Nhap_Kho_Raw_Data> F3001_sp_sel_List_NKRD_By_Nhap_Kho_ID(long p_iNhap_Kho_ID)
        {
            List<CXNK_Nhap_Kho_Raw_Data> v_arrRes = new List<CXNK_Nhap_Kho_Raw_Data>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F3001_sp_sel_List_NKRD_By_Nhap_Kho_ID", p_iNhap_Kho_ID);
