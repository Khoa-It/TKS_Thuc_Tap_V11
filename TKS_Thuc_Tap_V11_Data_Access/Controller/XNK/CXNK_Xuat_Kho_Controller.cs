...
namespace TKS_Thuc_Tap_V11_Data_Access.Controller.XNK
{
    public class CXNK_Xuat_Kho_Controller
    {
        ...
        public List<CXNK_Xuat_Kho> F3003_sp_sel_List_XK_By_Date_Only(DateTime? p_dtmFrom, DateTime? p_dtmTo)
        {
            List<CXNK_Xuat_Kho> v_arrRes = new List<CXNK_Xuat_Kho>();
            DataTable v_dt = new DataTable();
            ...
            try
            {
                ...
                CSqlHelper.FillDataTable(CConfig.TKS_Thuc_Tap_V11_Conn_String, v_dt, "F3003_sp_sel_List_XK_By_Date_Only", p_dtmFrom, p_dtmTo);
