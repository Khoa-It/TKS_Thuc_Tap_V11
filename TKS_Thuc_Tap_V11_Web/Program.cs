...
//    {
//        HostAppId = "TKS_Thuc_Tap_V11",
//        Storage = new FileStorage(),
//        ReportResolver = (Telerik.Reporting.Services.Engine.IReportResolver)
//            new UriReportSourceResolver(Path.Combine(env.ContentRootPath, "Reports")),
...
// Phần thông tin cấu hình báo cáo
...
builder.Services.TryAddSingleton<IReportServiceConfiguration>(sp =>
    ...
    {
        ReportingEngineConfiguration = sp.GetService<IConfiguration>(),
        HostAppId = "TKS_Thuc_Tap",
        Storage = new FileStorage(),
        ReportResolver = new ReportFileResolver(Path.Combine("Reports"))
...
builder.Services
    ...
    .AddTelerikReporting(); // ✅ đúng context
